...
function AddRouteModal({ onClose, onSuccess }) {
...
try {
  ...
  onSuccess(created.route ?? created);
  onClose();
} catch (err) {
...
return ( <Modal title="Add Route" onClose={onClose}> <form className="modal-form" onSubmit={handleSubmit}> <div className="modal-field"> <label htmlFor="route-name">Route name</label> <input
         id="route-name"
         name="name"
         value={form.name}
